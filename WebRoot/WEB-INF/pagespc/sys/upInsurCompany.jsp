			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="icgInscompanyShort"
						id="icgInscompanyShortId" value="${insurance.icgInscompanyShort}" 
						class="dfinput" size="35"/><i class="icgInscompanyShortspan"></i></td>
					<th align="right">联系人</th>
					<td><input type="text" name="icgInscompanyMan"
						id="icgInscompanyManId" value="${insurance.icgInscompanyMan}"  class="dfinput" size="35"
				...
				<tr>
					...
					<td><input type="text" name="icgInscompanyPhone"
						id="icgInscompanyPhoneId" value="${insurance.icgInscompanyPhone}"  class="dfinput" size="35" />
						<i class="icgInscompanyPhonespan"></i>
						</td>
					<th>传真</th>
					<td><input type="text" name="icgInscompanyFax" value="${insurance.icgInscompanyFax}" 
				...
				<tr>
					...
					<th>账号</th>
					<td><input type="text" name="icgInscompanyAccount" value="${insurance.icgInscompanyAccount}"
				...
				<tr>
					...
					<td colspan="3"><input type="text" name="icgInscompanyRemark"
						id="icgInscompanyRemarkId" class="dfinput" size="70" value="${insurance.icgInscompanyRemark}"
						/><i class="icgInscompanyRemarkspan" ></i></td>
				</tr>
				<tr align="center"><td colspan="4">
				<input type="button" value="修改保存" onclick="addInsurCompany()" class="ibtn">
